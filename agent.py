...
def run_ai_agent():
    ...
    # Target 30 questions total by asking for 2 batches of 15
    ...
    try:
        ...
        for batch_num in range(num_batches):
            print(f"Generating batch {batch_num + 1}/{num_batches} (15 questions)...")
            ...
            Generate EXACTLY 15 pyramidal tossup questions following these official rules:
            - Question Structure: {rules['question_structure']}
            - Clues go from obscure to accessible giveaway.

            Output STRICT JSON array with exactly 15 items:
            [
              {{
                "id": 1,
        ...
        # Re-index Question IDs sequentially (1 to 30)
